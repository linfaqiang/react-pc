...
function InitiateSideMenu() {
    ...
    $("#sidebar-collapse").on("click", function () {
        ...
        if ($("#sidebar").attr("class") === "page-sidebar hide") {
            $(".logoBox").attr("class", "logoBox big")
        }else if($("#sidebar").attr("class") === "page-sidebar menu-compact"){
            $(".logoBox").attr("class", "logoBox smalll")
        }else{
            $(".logoBox").attr("class", "logoBox")
        }
    });
    $(".sidebar-menu").on("click", function (t) {
        ...
        if (i && i.length != 0) {
            if (!i.hasClass("menu-dropdown")) {
                return
                n &&
                i.get(0).parentNode.parentNode == this
                ? t : !1
                /*&& (
                    u = i.find(".menu-text").get(0),
                    t.target != u && !$.contains(u, t.target)
                ) ? !1 : void 0*/
            }
