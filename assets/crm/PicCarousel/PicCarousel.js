	...
	var PicCarousel = (function(){
		...
		PicCarousel.prototype = {
			...
			init:function(){
				...
				me.nextBtn = (me.settings.nextBtn)? $(me.settings.nextBtn) : me.poster.find("div.poster-next-btn"); 
				me.prevBtn = (me.settings.prevBtn)? $(me.settings.prevBtn) : me.poster.find("div.poster-prev-btn"); 
				me.posterItems = me.poster.find("li.poster-item");

				if(me.posterItems.size()%2 == 0){
					me.posterItemMain.append(me.posterItems.eq(0).clone());
					me.posterItems = me.posterItemMain.children("li.poster-item");
				}
