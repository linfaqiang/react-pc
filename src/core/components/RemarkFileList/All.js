		...
		var lis = lists.map(function(qst,key){
			...
			return <li key={key}>
						<div className="tx-img">
							<img name="defaultPic" style={{borderRadius:0}} src={imgSrc?imgSrc:APIS.img_path+"/assets/crm/images/ic-defalut-pic.png"} data-original={imgSrc?imgSrc:APIS.img_path+"/assets/crm/images/ic-defalut-pic.png"} width="55" height="55" alt=""/>
						</div>
						<h5>{originName}</h5>
