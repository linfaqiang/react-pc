							...
							<div role="grid" id="editabledatatable_wrapper" className="dataTables_wrapper no-footer">
								...
								<div className="row">
									...
									<div className="col-lg-4 col-md-4 col-sm-12 col-xs-12">
										<Detail getData={this.getData} finishedTask={this.finishedTask} executeTask={this.executeTask} detailData={this.state.detailData} ref="detailRef" detailList={this.state.detailList} executeList={this.state.executeList}/>
									</div>
