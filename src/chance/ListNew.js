...
module.exports = React.createClass({
    getInitialState:function(){
        return {
            canExport: false,
            tempUrl: APIS.chanceTemplate,
            importUrl: APIS.importChancesExcel,
            /*startUpload: false,
            percentage: 0,*/
            initParam:{
                "q":"",
                        ...
                        <div className="box-tabbs">
                            <div className="tabbable my" >
                                <ul className="nav nav-tabs myTab">
                                    <TabSelect2 liList={this.state.liList} curentSelect={this.state.curentSelect} setSelectType={this.setSelectType}/>
                                    ...
                                    <div style={{display:this.state.selectShow ? 'block' : 'none', width:380+'px',height:'auto', zIndex:100, position:'absolute',right:1+'px',top:42+'px'}}>
